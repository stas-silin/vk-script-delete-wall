...
5. Копируй только то, что внутри <script> ТОЛЬКО ЭТО </script> и вставляй скрипт - жми ENTER
...
не получается? Есть альтернативные скрипты здесь: https://ssilin.ru/blog/udalit-vse-posty-na-stene-vkontakte-2026-iyun/
